"""
Django settings for pizza_party project.
...
# Local path for media storage during dev
MEDIA_ROOT = os.path.join(BASE_DIR, "media/")
# Path where the media files are served
MEDIA_URL = '/media/'
...
WSGI_APPLICATION = 'pizza_party.wsgi.application'
